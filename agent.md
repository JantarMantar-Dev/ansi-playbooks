...
For routine capacity control, install the [safe recurring cleanup recipe](my-vps-management/docker_prune_cron.yml) using the production inventory. It never prunes volumes or networks; see [recurring node maintenance](docs/recurring-node-maintenance.md).
